...
export class EditComponent implements OnInit {
  ...
  save() {
    this.restService.save(Object.assign(this.current, this.echosForm.value), 'hist/recap_actions', null, 'id_inquiryform').subscribe((RecapActions) => {
      this.router.navigate(['/questionnaire', RecapActions.id_inquiryform]);
    }, (err) => {
      console.error(err);
    });
  }

...
import { RecapActions, RecapActionsExt } from '../../recap-actions';
...
export class DetailComponent implements OnInit {
  ...
  save() {
    ...
    this.restService.save(this.inquiryform, 'hist/inquiryforms', null, 'id_inquiryform').subscribe((RecapActions) => {
